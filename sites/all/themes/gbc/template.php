 ...
 */
function gbc_preprocess_html(&$vars) {
  ...
  load_subtheme_media_queries($media_queries_css, 'gbc'); // Replace 'footheme' with your themes name
  ...
  */
  ...
  load_subtheme_ie_styles($ie_files, 'gbc'); // Replace 'footheme' with your themes name
  // */
