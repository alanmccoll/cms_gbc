...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://itrva:1trv@com$@localhost/cms_gbc?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://itrva:1trv@com$@localhost:3306/cms_gbc?new_link=true');
  }
}
...
$civicrm_root = '/var/www/html/cms.goodwillbaptist.org/public_html/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/html/cms.goodwillbaptist.org/public_html/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https://cms.goodwillbaptist.org/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '7ad8444bfd16662e84772acdb89ea5a7');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/html/cms.goodwillbaptist.org/public_html/sites/default/files/civicrm/templates_c//mail.log');
// }
