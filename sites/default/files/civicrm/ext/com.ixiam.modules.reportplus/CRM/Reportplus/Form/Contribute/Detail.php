...
class CRM_Reportplus_Form_Contribute_Detail extends CRM_Reportplus_Form {
  ...
  public function __construct() {
    ...
    $this->_columns = array_merge($this->getColumns('Contact', [
      ...
      'fields_excluded' => ['id'],
      'fields_required' => ['id'],
      'filters_defaults' => ['is_deleted' => 0, 'is_deceased' => 0],
    ...
    // Show is_deceased in select
    $this->_columns['civicrm_contact']['fields']['is_deceased']['no_display'] = FALSE;
  }
